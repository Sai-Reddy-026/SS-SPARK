  ...
  return (
    <div className="min-h-screen flex bg-background">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative items-center justify-center overflow-hidden bg-[#070709] border-r border-border/40">
        ...
        <div className="absolute -bottom-32 -right-32 w-96 h-96 rounded-full bg-chart-1/15 blur-[120px] pointer-events-none animate-pulse-glow" style={{ animationDelay: "2s" }} />
        <div
          className="absolute inset-0 opacity-20 pointer-events-none"
          style={{
            backgroundImage:
              "radial-gradient(circle at 35% 45%, oklch(0.68 0.22 45) 0%, transparent 55%), radial-gradient(circle at 75% 25%, oklch(0.76 0.19 60) 0%, transparent 45%)",
          }}
        />
        ...
        <div className="relative z-10 max-w-lg px-12 text-center">
          ...
          {/* AI Showcase Card */}
          <div className="mb-8 rounded-2xl border border-white/10 bg-white/[0.03] p-4.5 text-left backdrop-blur-md shadow-2xl shadow-black/40">
            <div className="flex items-center justify-between mb-2.5">
              <div className="flex items-center gap-2">
                <span className="h-2 w-2 rounded-full bg-emerald-400 animate-pulse" />
                <span className="text-[11px] font-medium tracking-wide uppercase text-white/50">Grounded AI Analysis</span>
              </div>
            ...
            <p className="text-xs text-white/90 leading-relaxed font-mono bg-black/30 p-2.5 rounded-lg border border-white/5 mb-2">
              "Explain Dijkstra's Algorithm with time complexity."
            </p>
            <div className="flex items-center gap-2 text-[11px] text-white/60">
              <span className="rounded bg-primary/20 border border-primary/30 px-1.5 py-0.5 text-[10px] font-medium text-primary-foreground">
                Cited
              </span>
              <span>Question Paper 2024 · Page 3, Q4(b)</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-3.5">
            {[
              ...
              <div
                key={label}
                className="rounded-xl p-3.5 text-center border border-white/10 bg-white/[0.04] backdrop-blur-sm transition-all hover:bg-white/[0.07] hover:border-white/20"
              >
        ...
        <div className="w-full max-w-md relative z-10">
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center">
              <span className="bg-background px-3 text-xs text-muted-foreground/80">or continue with email</span>
            </div>
          </div>
          ...
          {/* Footer links */}
          <div className="mt-6 space-y-3.5 text-center text-sm text-muted-foreground">
            <p>
            ...
            <div>
              <button
                onClick={handleGuest}
                className="inline-flex items-center gap-1.5 rounded-full border border-border/50 bg-secondary/30 px-3.5 py-1.5 text-xs text-muted-foreground transition-all hover:bg-secondary/70 hover:text-foreground hover-glow cursor-pointer"
              >
